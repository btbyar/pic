...
- Одоогийн үе шат: **Phase 1** — monorepo, Docker Compose, Prisma схем, migration, seed
...
- **InsightFace лиценз:** `buffalo_l` зэрэг бэлэн сургасан модель нь арилжааны бус хэрэглээнд зориулагдсан. Production-д гарахаас өмнө арилжааны лиценз авах эсвэл өөр engine (`FaceEngine` interface) ашиглах шаардлагатай.
