...
const button =
  'inline-flex min-h-11 cursor-pointer items-center gap-2 rounded-xl border border-line bg-surface-2 px-3 text-sm font-medium text-ink transition  hover:text-ink';
