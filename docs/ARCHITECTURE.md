...
| 32 | Эвэнт олох | ❌ **Эвэнтийн нэгдсэн жагсаалт хасагдсан (2026-09-18, хэрэглэгчийн шийдвэр).** Оролцогч: Нүүр → Зурагчид (нэр/хотоор хайх) → профайл → тухайн зурагчны нийтийн эвэнтүүд. Эвэнтийн шууд холбоос/QR хэвээр ажиллана. `GET /events` байхгүй, `/events` хуудас `/photographers` руу чиглүүлнэ. Профайлаа нийтлээгүй зурагчинд самбарт сануулга гарна |
| 33 | Cover зургийн чанар | Эвэнтийн cover-т watermark-гүй 1600px тусдаа хувилбар (`events/<id>/cover/<photoId>.webp`) үүснэ — hero/баннер дээр бичиг муухай харагддаг. Галерейн preview (1000px) watermark-тай хэвээр. Зөвхөн cover зурагт үүсгэнэ; ingest-д эх файл гарт байхад, хуучин эвэнтүүдэд цагт нэг maintenance job (20 ширхэгээр) |
| 34 | Эвэнтийг нэрээр хайх | `GET /events/search?q=` (≥2 тэмдэгт, 12 хүртэл) — оролцогч эвэнтийнхээ нэрийг мэддэг ч зурагчныг нь мэдэхгүй байдаг. Хоосон/богино хайлтад юу ч буцаахгүй тул #32-ийн "жагсаалт байхгүй" шийдвэр хэвээр |
| 35 | Эвэнтийн QR | Зурагчин эвэнт бүрт хэвлэдэг A4 QR зурагт хуудастай (`/photographer/events/[id]/poster`). QR нь нийтийн эвэнтийн URL-ийг агуулна; сервер талд SVG-ээр зурна (`qrcode`) |
